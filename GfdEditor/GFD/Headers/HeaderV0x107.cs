...
namespace GfdEditor.GFD.Headers
{
    public class HeaderV0x107
    {
        ...
        public HeaderV0x107(BinaryReader br)
        {
        ...
        public HeaderV0x107(BaseGFDHeader baseGFDHeader)
        {
            ...
            GlyphCount = baseGFDHeader.GlyphCount;
        ...
        public void WritePropriedades(BinaryWriter bw)
        {
            ...
            bw.Write(GlyMaxWidth);
            bw.Write(GlyphMaxHeight);
            bw.Write(Baseline);
            bw.Write(Descender);
